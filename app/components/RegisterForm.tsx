        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              />
              {errors.first_name && (
                <p className="text-red-500 text-xs italic mt-1">{errors.first_name.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.last_name && (
                <p className="text-red-500 text-xs italic mt-1">{errors.last_name.message}</p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            {errors.date_of_birth && (
              <p className="text-red-500 text-xs italic mt-1">{errors.date_of_birth.message}</p>
            )}
          </div>
