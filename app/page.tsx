        ...
        <section className="w-full bg-gradient-to-r from-[#ffeaea] to-[#ebc4f0] py-30 px-8 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-xl space-y-10 md:ml-30 lg:ml-30">
            ...
            <h1 className="font-bold text-5xl md:text-6xl leading-tight">
              <p>Personalized i m her</p> <br /> Menopause <br /> Care for
              Canadians
            </h1>
              ...
              >
                <div className="mb-4 group-hover:scale-110 transition-transform">
                  <Image
                    ...
                    style={{
                      filter:
                        "invert(20%) sepia(0%) saturate(0%) hue-rotate(0deg) brightness(0.5)",
                    }}
                  />
                </div>
          ...
          <div className="max-w-6xl mx-auto flex flex-col gap-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-65 items-center">
              <div>
                ...
                <p className="text-gray-600">
                  Complete our comprehensive assessment to help us understand
                  your unique symptoms and health history
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-65 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-gray-600">
                  Meet with Canadian menopause specialists via secure video call
                  to discuss your personalized care plan
                </p>
              </div>
            </div>
            {/* Step 3 */}
            ...
            <div className="flex-1 flex flex-col justify-center items-start">
              ...
              <div className="mb-6">
                <p className="text-lg text-gray-700 leading-relaxed mb-10">
                  Dr. Nathan Roth is a leading expert in women's health with
                  over 30 years of experience in obstetrics, gynecology, and
                  infertility. He is the current Chair of the American Congress
                  of Obstetrics and Gynecology (ACOG) Section and Medical
                  Director at Hope Fertility.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Dr. Roth has served as a medical advisor, chaired national
                  health committees, and held leadership roles at The
                  Scarborough Hospital Network. He now leads cervical cancer
                  screening for Cancer Care Ontario, advancing health equity
        ...
        <div className="w-full flex flex-col md:flex-row justify-center items-start gap-20 px-8 md:px-24 py-20">
          ...
          <div className="md:w-1/3 w-full mb-10 md:mb-0">
            ...
            <p className="text-lg text-gray-700 mb-2 text-left">
              Everything you want to know about menopause care, HormoneFit, and
