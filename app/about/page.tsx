...
export default function AboutPage() {
	return (
		<main className="bg-white min-h-screen font-sans text-blacktxt">
			{/* About HormoneFit Section - Main Heading & Mission */}
			<section className="bg-gradient-to-r from-[#f3e8ff] to-[#e0cff1] px-8 py-24 text-center">
				<div className="max-w-4xl mx-auto">
					...
					<h2 className="text-3xl md:text-4xl font-bold text-blacktxt mb-6 leading-tight">
						Our Mission
					</h2>
					<p className="text-lg text-gray-700 font-normal mb-4 max-w-3xl mx-auto">
			...
			<section className="px-8 py-20 bg-white">
				<div className="max-w-5xl mx-auto">
					<h2 className="text-3xl md:text-6xl font-bold text-accent1 mb-12 text-center">
						Our Approach
					</h2>
			...
			<section className="px-8 py-20 bg-accent1/5">
				<div className="max-w-5xl mx-auto">
					...
					<div className="bg-white rounded-lg p-8 shadow-md border border-gray-200 flex flex-col md:flex-row items-center md:items-start gap-8">
						<div className="w-48 h-48 md:w-60 md:h-60 rounded-full bg-gray-200 flex-shrink-0 flex items-center justify-center overflow-hidden">
			...
			<section className="px-8 py-20 bg-white">
				<div className="max-w-5xl mx-auto">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						...
						{/* Comprehensive Care */}
						<div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
							<h3 className="text-2xl md:text-3xl font-bold text-accent1 mb-2">Comprehensive Care</h3>
							<p className="text-gray-700">
						...
						<div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
							<h3 className="text-2xl md:text-3xl font-bold text-accent1 mb-2">Full Spectrum of Options</h3>
							<p className="text-gray-700">
			...
			<section className="px-8 py-20 bg-accent1/5">
				<div className="max-w-4xl mx-auto">
					...
					<div className="space-y-4">
						{/* Value 1 */}
						<div className="bg-white rounded-lg p-6 shadow-sm border border-accent1/20">
			...
			<section className="px-8 py-20 bg-white">
				<div className="max-w-5xl mx-auto text-center">
					<h2 className="text-3xl md:text-6xl font-bold text-accent1 mb-12">
						Press & Media
					</h2>
					...
					<div className="flex flex-wrap justify-center gap-6">
						<button className="bg-gray-100 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition">Forbes</button>
						<button className="bg-gray-100 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition">Women's Health</button>
						<button className="bg-gray-100 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition">The New York Times</button>
						<button className="bg-gray-100 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition">CNN Health</button>
					</div>
				</div>
			</section>
